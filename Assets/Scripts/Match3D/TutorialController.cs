...
namespace FootballStar.Match3D {
	...
	public class TutorialController : MonoBehaviour {
		...
		IEnumerator TutorialSequence()
		{
			...
			// Evento de tutorial: Juegas con lo aprendido
			...
			while(true) {
				...
				// Evento de tutorial: Repites la jugada porque no has jugado bien con lo aprendido.

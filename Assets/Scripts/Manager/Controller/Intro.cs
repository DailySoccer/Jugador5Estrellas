	...
	public class Intro : MonoBehaviour
	{
		...
		void OnYesButtonClick()
		{
			...
			if (enabled) {
				...
				parameters.Add(AFInAppEvents.GROWN_PERSON, "si");
				AppsFlyer.trackRichEvent(AFInAppEvents.GROWN_PERSON, parameters);
		...
		{
			System.Collections.Generic.Dictionary <string,string> parameters = new System.Collections.Generic.Dictionary<string, string> ();
			parameters.Add(AFInAppEvents.GROWN_PERSON, "no");
			AppsFlyer.trackRichEvent(AFInAppEvents.GROWN_PERSON, parameters);
#if UNITY_WEBPLAYER
